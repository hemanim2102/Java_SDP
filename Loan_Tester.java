...
public class LoanTester {
    public static void main(String[] args) {
        ...
        Loan1 loan1 = new Loan1(123, 456, 10000.0f, 12, 5.0f);
        Loan1 loan2 = new Loan1(789, 101, 15000.0f, 24, 7.5f);

        // Create 2 objects of Loan class using parametrized constructor
        Loan1 loan3 = new Loan1(111, 222, 20000.0f, 18, 6.0f);
        Loan1 loan4 = new Loan1(333, 444, 12000.0f, 36, 8.0f);
...
class Loan1 {
    ...
    // Constructors
    public Loan1(int accountNo, int customerNo, float loanAmount, int loanDuration, float interest) {
